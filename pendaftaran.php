...
?>
	<div class="alert alert-<?php echo "danger"; ?>">
        <strong> </strong> Daftar Akun Baru
    </div>
<form action="register.php" method="post" role="form">
	<div class="form-group">
		<label class="control-label" for="namalengkap">Nama Lengkap:</label>
			<input type="text" id="namalengkap" placeholder="Nama Lengkap" name="nama_lengkap" class="form-control input-small" />
					</div>
					<div class="form-group">
					<label class="control-label" for="jeniskelamin">Jenis Kelamin:</label>
						<select name="jenis_kelamin" class="form-control input-small" required ><option value="">Silahkan Dipilih...</option>
					...
					<div class="form-group">
						...
						<input type="text" id="hp" placeholder="Handphone" name="hp" class="form-control input-small" />
					</div>
